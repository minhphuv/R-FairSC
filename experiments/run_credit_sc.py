"""Run standard spectral clustering on the Credit dataset."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run SC on Credit.")
    ...
    parser.add_argument("--output", default="results/credit_sc.csv")
