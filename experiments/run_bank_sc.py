"""Run standard spectral clustering on the Bank dataset."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run SC on Bank.")
    ...
    parser.add_argument("--output", default="results/bank_sc.csv")
