"""Run A-FairSC on the Diabetes dataset."""
...
def run_experiment(args: argparse.Namespace) -> pd.DataFrame:
    ...
    print(
        f"Diabetes largest connected component: "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run A-FairSC on Diabetes.")

    parser.add_argument("--edges", default="data/diabetes/edges.csv", help="Path to edges.csv.")
    parser.add_argument("--colors", default="data/diabetes/gender.csv", help="Path to gender.csv.")
    parser.add_argument("--color-column", type=int, default=1, help="Sensitive attribute column index.")
    parser.add_argument("--output", default="results/baselines_diabetes_afairsc_time_fair_x.csv")
    parser.add_argument("--clusters", nargs="+", type=int, default=[2, 4, 6, 8, 10])
