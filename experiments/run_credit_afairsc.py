"""Run A-FairSC on the Credit dataset."""
...
def run_experiment(args: argparse.Namespace) -> pd.DataFrame:
    ...
    print(
        f"Credit largest connected component: "
    ...
    for group_value, count in zip(dataset.group_values, dataset.group_counts):
        print(f"size of education group {group_value}: {count}")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run A-FairSC on Credit.")
    parser.add_argument(
        "--edges",
        default="data/credit/credit_edges.csv",
        help="Path to credit_edges.csv.",
    )
    parser.add_argument(
        "--colors",
        default="data/credit/credit_colors.csv",
        help="Path to credit_colors.csv.",
    )
    parser.add_argument(
        "--output",
        default="results/baselines_credit_afairsc_time_fair_x.csv",
