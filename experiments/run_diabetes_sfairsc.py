"""Run sFairSC on the Diabetes dataset."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run sFairSC on Diabetes.")
    ...
    parser.add_argument("--output", default="results/diabetes_sfairsc.csv")
