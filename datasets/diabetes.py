"""Diabetes dataset preparation for R-FairSC experiments."""
...
def load_diabetes_dataset(
    edges_path: str | Path = "data/diabetes/edges.csv",
    colors_path: str | Path = "data/diabetes/gender.csv",
    color_column: int = 1,
) -> DiabetesDataset:
    """Load Diabetes, keep its largest component, and build F and G."""
